...
| G71 | [ ] | NJ BF_MAGIC charm bonuses: NJ_KOUENKA +20/charm (fire), NJ_KAENSIN +10/charm (fire), NJ_BAKUENRYU +15/charm (fire), NJ_HYOUSYOURAKU +25/charm (water), NJ_RAIGEKISAI +15/charm (wind), NJ_KAMAITACHI +10/charm (wind). Source: battle.c:1699-1755. Requires `sd->charm_type` + `sd->charm_count` — new PlayerBuild fields + NJ_SOULCOLLECT skill mechanic. | future |
