...
| G49 | [~] | Buffs section UI: role-grouped collapsible panel. M0: skeleton + Self Buffs wired. M: Party Buffs sub-group wired (SC_BLESSING/INC_AGI/GLORIA/ANGELUS/IMPOSITIO/ADRENALINE). Remaining: Bard Songs, Dancer Dances, Ground Effects (Sessions M2/N/O). | M–N |
