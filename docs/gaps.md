...
| G69 | [ ] | MO_EXTREMITYFIST ratio formula is incorrect. Current impl: `min(100+100*(8+sp//10), 60000)` in `skill_ratio.py`. Re-read battle.c:2197-2206 #ifndef RENEWAL and fix in Q3. | battle.c:2197-2206 #ifndef RENEWAL |
